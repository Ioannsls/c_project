...
static void print_time(const char *type, const struct timespec *ts) {
 	...
 	char buffer[sizeof("YYYY-mm-dd HH:MM:SS")]; //Создаем хранилище под дату и время
...
{switch (mode & S_IFMT) {//пробегаем по всевозможным случаям
...
int main(int argc, char *argv[])
{
	...
	//Освобождаем память, т.к. эта нам больше не нужна.
